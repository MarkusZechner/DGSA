...
function [NormalizedInteractions,StandardizedSensitivityInteractions,H0accInter] = dGSA_Interactions(Clustering,ParametersValues,InteractionsNames,NbBins,alpha)
%%% 2 is added because this uses Pareto_GlobalSensitivity2 to overrride not
%%% to ordering the sensitivities according to ascending order.
%% Input Parameters
...
%Pareto_GlobalSensitivity2(StandardizedSensitivityInteractions,InteractionsNames,H0accInter)
