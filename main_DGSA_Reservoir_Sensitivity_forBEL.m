...
% History
prior_path = 'Z:/Projects/BM/Code/Data/BM_NFA_first/Prior_prediction_OilRate.mat';
load(prior_path);

% taking history out
Data = Prior_Property_forecast.data_NotOrdered; % we can keep the original ordering for history

plot(Prior_Property_forecast.time,Data(1,:))
...
parameter_path = 'Z:/Projects/BM/Code/Data/Parameters_NFA_short.csv';
