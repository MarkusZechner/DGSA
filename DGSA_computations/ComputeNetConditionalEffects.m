function [NetConditionalEffects,Bin_MaxNetConditional]=ComputeNetConditionalEffects...
    (ParameterSpecified, DGSA,Ylegend)
...
% DisplayPlotFlag: logical, if true, disply horizontal bars to display conditional effects.

%Output:
% NetConditionalEffects:matrix (NbBins x (# of Parameters-1)): contains net conditional effects of the specified parameter
% Bin_MaxNetConditional: scalar, the maximum 

    

%% Assgin varaiables

%SensitivityByCluster_Bins=DGSA.ConditionalEffects.SensitivityByCluster;
