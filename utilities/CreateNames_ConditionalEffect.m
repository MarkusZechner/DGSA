...
% Input:
% ParametersNames (1 X # of Parameters): cell object containing names of uncertain parameters
%
% Output: 
% ConditionalEffectNames (1 X (# of Parameters)*(# of Parameters-1)) : cell object containing names of conditional effects
%
% Example:
% ParameterNames={'X','Y','Z'} will gives output of ConditionalEffectNames={'Y|X','Z|X','X|Y','Z|Y','X|Z','Y|Z'}
%%

ConditionalEffectNames=cell(1,(length(ParametersNames)^2-length(ParametersNames)));
ncount=0;
