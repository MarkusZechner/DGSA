...
% Input
% tgrid: vector, grid of time
% responses: matrix (# of models for Sobol's method x timesteps), containing responses of each model
% N_unit_simul: scalar, # of initial Monte Carlo samples to apply Sobol's method. This corresponds to n (sample size).
% ParametersNamses: cell, contains names of parameters
...
%%
NbTotalSimul=size(responses,1); % In Sobol's method n(k+2) simulations are required where n=sample size and k is the number of parameters
