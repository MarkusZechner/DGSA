...
% Input:
% StandardizedSensitivity ( # of Parameters x 1 x 3) : Main effects standardized by averaging over clusters
% H0accMain (# of Parameters X 1): Logical values, if 1, H0 is rejected (sensitive), otherwise accepted (insensitive)
% ParametersNames : 1 X # of Parameters, cell obejects containing the names of uncertain parameters
