...
% GlobalSensitivityInteractions: vector containing the standardized conditional effect
% StandardizedSensitivity: vector containing main effects
% ParametersNames: Cell containing names of parameters
% ScaleFactor: scalar, This value will scale the size of bubble on h-plot. Higher value decreases the size of bubbles. 
% Fontsizes: scalar, Fontsize of names of parameters in h plot

% Output:

% H (optional): Coordinates of each parameter at h-plot
